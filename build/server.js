...
var connectToMongo = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_1 = _a.sent();
                logging_1.default.error(NAMESPACE, "Error connected to MongoDB", error_1);
                return [3 /*break*/, 3];
...
// Routes
app.use('/', features_1.default);
// Server
var server = http_1.default.createServer(app);
server.listen(config_1.default.server.port, function () {
    return logging_1.default.info(NAMESPACE, "The server is running on port " + config_1.default.server.port);
});
